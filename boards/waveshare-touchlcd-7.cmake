# Board: Waveshare ESP32-P4 Touch LCD 7"
# 720x1280 portrait MIPI DSI panel (ILI9881C), used in landscape (1280x720) via sw_rotate.

set(BOARD_NAME "waveshare-touchlcd-7")
set(BOARD_HARDWARE_ID "waveshare-touchlcd-7")
...
set(BOARD_SDKCONFIG_DEFAULTS
    ...
    "${CMAKE_SOURCE_DIR}/boards/waveshare-touchlcd-7/sdkconfig.defaults"
)

# Custom partition table with dual OTA
set(BOARD_PARTITION_TABLE "${CMAKE_SOURCE_DIR}/boards/waveshare-touchlcd-7/partitions.csv")

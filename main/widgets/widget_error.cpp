...
void WidgetError::createUI()
{
    ...
    lv_obj_set_style_text_font(warningIcon, &lv_font_montserrat_24, 0);
    ...
    lv_obj_set_style_text_font(errorLabel, &lv_font_montserrat_28, 0);
    ...
    lv_obj_set_style_text_font(typeLabel, &lv_font_montserrat_24, 0);
    ...
    lv_obj_set_style_text_font(sizeLabel, &lv_font_montserrat_22, 0);
